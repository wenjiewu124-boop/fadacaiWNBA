...
try:
    ...
    print("⚙️ [2/4] 正在执行生产级数据预处理 (复刻 main.py 逻辑)...")
    ...
    # 🚨 本次修复核心：将 Timestamp 对象强转为字符串，防止 JSON 报错！
    ...
    for i in range(0, len(records), batch_size):
        ...
        print(f"   ⬆️ 成功推入第 {i+1} 到 {min(i+batch_size, len(records))} 条记录...")
